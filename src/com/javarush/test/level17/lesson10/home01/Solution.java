...
/* Общий список
1. Изменить класс Solution_1 так, чтобы он стал списком. (Необходимо реализовать интерфейс java.util.List).
2. Список Solution_1 должен работать только с целыми числами Long.

...
public class Solution {
    ...
    private class SuperUser {
        ...
        //доступ к этому методу возможен только внутри класса Solution_1, т.к. модификатор иннер класса private
    ...
    public static void main(String[] args) {
        ...
        //внутри класса Solution_1 (а сейчас мы внутри) к методу getDescription можно обращаться обоими способами
